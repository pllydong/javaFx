...
import tourism.constant.FilePathConstant;
import tourism.constant.NumberConstant;
import tourism.constant.UiConstant;
import tourism.model.*;
import tourism.utils.ExecutorUtils;
import tourism.utils.HttpUtils;
import tourism.utils.KeyValueFileUtils;
import tourism.utils.UseThisUtils;
...
import static tourism.constant.ConfigKeyConstant.*;
...
//        }
    ...
    private void execScanTask(List<ProductV2> collect, String msg) {
        if (DateUtil.date().after(DateUtil.parse("2024-05-24"))) {
            Platform.runLater(() -> {
                log("\u7a0b\u5e8f\u5df2\u8fc7\u671f\uff0c\u8bf7\u4f7f\u7528\u6b63\u5f0f\u7248\u672c");
            });
            return;
